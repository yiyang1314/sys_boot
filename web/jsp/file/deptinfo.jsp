...
<html>
	...
	<body>
		<fieldset>
			...
			<p>部门编号: ${deptplus.deptno }</p>
			<p>部门名称: ${deptplus.dname}</p>
			<p>部门地址: ${deptplus.loc }</p>
			...
			<c:forEach var="emp" items="${deptplus.emplist}">
				<tr>
		...
		<a href="jsp/file/empupdate.jsp?deptno=${deptplus.deptno }">添加</a>
		<a href="dept_page">返回部门列表</a>
		<a href="emp_page">返回员工列表</a>
		<a href="wain.jsp">返回</a>
